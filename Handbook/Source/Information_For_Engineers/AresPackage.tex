...
The following diagram is a graphical representation of the schema.
\placefigure
    [force][figure:AresPackageManifestSchema]
    {The schema for the {\tt AresPackage} root node of a manifest.}
    {\externalfigure[Source/Information_For_Engineers/Images/AresPackage/Root.png][][width=1\textwidth]}
\placefigure
    [force][figure:AresPackageManifestSchema]
    {The schema for the {\tt Files} element of an AresPackage manifest.}
    {\externalfigure[Source/Information_For_Engineers/Images/AresPackage/Files.png][][width=1\textwidth]}
\placefigure
    [force][figure:AresPackageManifestSchema]
    {The schema for the {\tt File} tag of an AresPackage manifest.}
    {\externalfigure[Source/Information_For_Engineers/Images/AresPackage/File.png][][width=1\textwidth]}
