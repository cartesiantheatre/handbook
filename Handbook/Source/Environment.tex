...
% Revision control...
    ...
    \def\BzrRevisionClickable{%
        \href{https://blueprints.launchpad.net/avaneya/+spec/avaneya-project-crew-handbook}{\BzrRevision}
    }
...
% Setup bibliography...
    ...
    \setupbibtex[database={Source/References/References}, sort=author]
    ...
    % Macro to put the cites in the footer...
    %\let \citeasfootnote \cite
    %        \unexpanded\def\cite#1{\footnote{\citeasfootnote{#1}}}
...
\defineoverlay[BackgroundImage][\overlayfigure{Source/Makeup/Images/Background.png}]
\setupbackgrounds
    [page]
