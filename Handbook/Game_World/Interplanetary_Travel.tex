...
A \index{minimum--energy launch window}minimum--energy launch window is the time when the least amount of energy is required to send an object from one orbit in the solar system to another. It can involve taking advantage of the orbital positions of both the start and destination, useful gravitational fields {\it en route}, and so on. In the case of a trajectory from Earth to Mars, this occurs at intervals of approximately 2.135 years or every 780 days. Depending on the constraints one is trying to optimize for, such as energy, time, safety, whether the cargo is piloted or unpiloted, different manoeuvres are available.
