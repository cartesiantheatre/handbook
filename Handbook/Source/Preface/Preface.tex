...
This document will likely continue to be revised and improved with time. Therefore, because it is a living document, it is probably better to pass on a \href{http://bazaar.launchpad.net/~avaneya/avaneya/trunk/view/head:/Documentation/Contributors/Handbook/Avaneya\%20Project\%20Crew\%20Handbook.pdf}{link} to the latest revision within our Bazaar repository\footnote[]{See \in{section}[Revision Control Management] for details in accessing the Bazaar source repository.} than it is to send a locally stored one to another person.
