...
\StartTimelineDate{A.R.}
A survey team is deployed on a routine assignment where it uses its ground based shallow radar to scout for artesian aquifiers. Travelling solo, Arda departs Arcadia to rendezvous with the team. Midway he goes EVA to dismount the rover and check on one of its tires. While checking the tire, he is knocked off of his feet as an explosion occurs on the other side of the rover from within the cabin. The cabin fully depressurizes and is too badly damaged to maintain positive pressure. Although uninjured, the rover's electronics are non-responsive, rendering the machine derelict in the middle of a Martian desert. The nearest rescue effort that acknowledges his emergency transponder is at least 42 hours away. With only 35 hours of liquid oxygen remaining for his EVA's respirator, he manages to extend it in time by siphoning cryogenic liquid oxygen from the rover's propulsion system.

Later analysis of the damaged rover finds chemical residue of a gaseous methane / oxygen (\chemical{CH_4 / O_2}) container that had been under high pressure. The rover's own equipment is ruled out since the fuel cells are methanol (\chemical{CH_3OH}) based and have no need for methane. In an effort to determine who last serviced the rover, the mechanics determine the maintenance log is missing. They later find remnants of what appears to be fragments of a timer based detonator still in the cabin.
\StopTimelineDate
