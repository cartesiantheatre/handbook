...
% External program version strings...
    ...
    \def\initializeEvince
        {\ctxlua{context.setgvalue("EvinceVersion", os.resultof"evince --version | tr -d '\\n'")}}
    \initializeEvince
...
% Set the background image...
    ...
    \defineoverlay
      [PageBackgroundImage]
      [{\ifnum\rawcountervalue[realpage]=1\relax
          \overlayfigure{Makeup/Images/Cover.png}%
        \else
