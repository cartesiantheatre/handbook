...
%A new window will open. Once again in location type: "lp:avaneya" and then click ok. This will then upload you locally modified files to avaneya's launchpad.

%Remember: pageant and you private SSH key are required to be opened during use of lp:avaneya.
