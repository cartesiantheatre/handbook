...
%The production, import and export of goods, and internal use of the goods make up the cities economy.  It also deals with a cities income and expenditures and how these are managed by the player.  
