...
Study the images carefully. You will note that both \alpha\ Cephei and Deneb are \quote{fixed} in the sky with respect to the \index{celestial pole}celestial pole, the axis the planet rotates on. Both stars are on opposite sides of the celestial pole and about equal distance from it. This means that celestial north is always found in almost exactly the half way point between these two stars.
