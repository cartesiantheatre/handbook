...
All chemical elements have one or more \quote{exotic} variants of themselves that occur less frequently in nature. These elements share the same atomic number, but vary only in the number of neutrons they contain. These are called {\it isotopes\index{isotope}}.

Hydrogen is denoted as \chemical{H} and is known to occur naturally as one of two isotopes. The more common form has one proton, one electron, and no neutrons. This form is called {\it protium\index{protium}} and is sometimes denoted \chemical{^1H} when distinguishing from another hydrogen isotope. Usually when someone is talking about hydrogen, they are talking about this protium form. The one found in the notation means that it has an atomic mass of one. Note that the atomic mass is one because electrons have nearly zero mass, although neutrons and protons have an atomic mass of one. This means that isotopes of the same chemical element still vary in atomic mass. 

The only other known isotope is {\it deuterium} and is denoted \chemical{^2H}. It has a neutron that protium does not, hence the atomic mass of two in its notation. When two deuterium atoms are combined with an oxygen atom, the resultant is deuterium oxide \chemical{^2H_2O}, or simply {\it heavy water\index{heavy water}}.
...
The \goto{RWGS}[Reverse-Water-Gas-Shift Reactor] reactor heavily relied upon by Arcadians to produce water from the Martian atmosphere can also produce deuterium as an inadvertent byproduct. If the water emerging from the RWGS reactor is split through electrolysis, hydrogen fuel and oxygen result. For every 6,000 kg of \chemical{H_2O} the reactor produces, 1 kg of that will contain deuterium. Since the diluted heavy water takes slightly longer to split with electrolysis than regular water, if you keep cycling the water that has not yet been split back through electrolysis, eventually the concentration of heavy water increases until it is almost totally pure.

By the late 20\high{th} century, deuterium was valued on Earth at about 70\% that of gold per kilogram. It has wide ranging applications from nuclear fusion and fission reactors, medical, nuclear weapons, biochemical, environmental, and more. If in heavy water form, it can be used in non-uranium enriched fission reactors that poor Terran countries could benefit from.

Since Mars is much less massive than Earth, only a fourth the energy required to exceed Earth's escape velocity is required on Mars to get things off of the planet. This makes deuterium \goto{railgun}[Railgun] exports back to Earth feasible where it is a highly valued commodity. Since all water, oxygen, and many other Arcadian industrial processes relying on the RWGS reactor produce deuterium as an inadvertent byproduct, the settlement can always have something valuable and sought after in the Terran market.
