...
Henrik is promoted to the Office of the Secretary of State. For his courage in the defence of the city, he is awarded the {\it Order of Arcadia}\index{Order of Arcadia}, the republic's highest civic and military honour -- and the first of it. Unit citations are awarded for the first time to the {\it 1\high{st} People's Own Arcadian Mechanized Infantry}, {\it 2\high{nd} People's Own Arcadian Dragoons}, and the {\it 3\high{rd} People's Own Arcadian Combat Support Engineers}.
\StopTimelineDate
...
The transportation secretary informs Arcadia Hall of the police investigators preliminary findings. The tail number was registered to an NAU-CIA contractor for UN diplomatic flights. Chemical analysis determines the origin of the narcotic payload to be of probable Martian origin, but of a more addictive and dangerous synthetic form.
