...
\placefigure
    [][figure:AresPackageManifestSchema]
    {The schema for the {\tt AresPackage} root node of a manifest.}
    {\externalfigure[Images/AresPackage/Root.png][][width=.95\textwidth]}
\placefigure
    [][figure:AresPackageManifestSchema]
    {The schema for the {\tt Files} element of an AresPackage manifest.}
    {\externalfigure[Images/AresPackage/Files.png][][width=.95\textwidth]}
\placefigure
    [][figure:AresPackageManifestSchema]
    {The schema for the {\tt File} tag of an AresPackage manifest.}
    {\externalfigure[Images/AresPackage/File.png][][width=.95\textwidth]}
