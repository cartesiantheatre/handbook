...
\placefigure
    [right,2*hang]
    {Captured by Viking 1 Orbiter on 22 February 1980, Valles Marineris is the scar on Mars over 3000 km long and up to 8 km deep.}
...
Although higher end gaming for GNU is long overdue and many of its users often feel as though they are treated as second class citizens in this regard, there will, however, be nothing the developers will do to deliberately hinder porting the game to non-free or other platforms if one wishes to do so.
...
Some have suggested that maintaining for free platforms can be rather limiting in terms of user outreach. There was a time when this view had validity. Now, with tens of millions of users worldwide running some flavour of GNU, such as Ubuntu, the perception of a non-existent or marginal demographic  is rather antiquated. Consider that gaming under non-free operating systems such as OS X is still active and lively today, and yet Ubuntu alone (not including other GNU distributions) has arguably surpassed it in terms of popularity.\footnote{\fullahref{http://www.freesoftwaremagazine.com/columns/ubuntu_surpasses_mac_osx}}

When the GNU project set out to replace the body of non-free software required to use a computer, it also required games because a complete system needs games too.\footnote{\fullahref{http://www.gnu.org/gnu/linux-and-gnu.html}} One of the aims of this project is to help achieve that goal.
