...
Avaneya is a {\it sui generis}. It is not like other games, and thus it is not for all people. It does not try to be, nor will it ever be. Those seeking a casual game, and there is nothing wrong with that, will probably not enjoy this one. There are already many such games, so that need not be our aim here.
