...
Note that you should replace the {\it fonts-lmodern} package name with {\it lmodern} if you are not running Ubuntu Raring, but Ubuntu Quantal. If you are instead using Ubuntu Precise or older, you can \href{http://distribution.contextgarden.net/current/fonts/new/fonts/opentype/public/lm-math/latinmodernmath-regular.otf}{download} the {\tt latinmodernmath-regular.otf} font directly into your {\tt \type{~}/.fonts} path. This font is needed to typeset various mathematical formulae.
