...
When the reactants are combined in their liquid states, \chemical{CH_4 / LOx}, even greater quantities can be packed into the same volume by a factor of three. This is possible because fluid densities are much greater than gasses. This gives an explosive yield roughly twice that of TNT, \chemical{C_6H_2(NO_2)_3CH_3}. One drawback is that liquid states require the reactants be stored at cryogenic temperatures to reduce boil--off.
...
Since visibility at night is very difficult on Mars (\in{section}[Desert Threats]), night vision or thermal imaging optics are useful. When using only iron sights, the reliable glow of tritium engraved front and rear posts would be helpful in low light conditions.
