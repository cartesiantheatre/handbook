...
Heroin was once a household children's cough medicine,\footnotecite[edwards2011_bayer_heroin_ads_for_children] opium was in the snuffbox of every gentleman of distinction, and lithium in 7-Up.\footnotecite[best2014_lithium_7up] Today we reserve methamphetamine for the junky; Oreos for the office;\footnotecite[schroeder2013_oreos_like_drugs] and socially validated\footnotecite[ubc_wine_research_centre_home] alcohol overall more harmful\footnotecite[extras={ See figure 2.}][nutt2010] than virtually anything found on the street for every occasion. These arbitrary social values are whatever we need them to be, rationalized only after the fact that a historical precedent had already been set.
