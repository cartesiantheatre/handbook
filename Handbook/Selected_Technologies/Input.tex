...
OIS is an object--oriented API for Ogre3D which is used to provide \index{user input handling}input handling. Input starts at this low level API and is used to message pump CEGUI and anything else that needs to know what the user is doing.
\stopitemize
