...
\StartTimelineDate{A.R.}
{\it Kali's} launch window is missed due to low-Earth orbit having become overly saturated with space debris. UNSA engineers fear they may be approaching the Kessler effect of causing a runaway chain reaction which would reduce all objects in orbit. Since this threatens not only the {\it Iterum Shipyard}, but all Terran space exploration, {\it Kali's} trans-Martian injection must be rescheduled for the next available launch window of 25 months.
\StopTimelineDate

\StartTimelineDate{A.R.}
Arda holds an emergency cabinet meeting at {\it Arcadia Hall} in secrecy. Several hours into the meeting, Arda summons several geologists and engineers where they are briefed before being deployed abroad by way of rovers and a dirigible.
\StopTimelineDate
