...
Another important reason why this project is necessary is that there is very little, if any, {\it free}, commercial, games for the GNU operating system. Even though there are many non--free games available for it, they ignore the issue of freedom.\footnote[nonfree_drm_games_on_gnu_linux] This is ironic because that is why the operating system was created in the first place. 
