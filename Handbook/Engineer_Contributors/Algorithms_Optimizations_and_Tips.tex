...
\placefigure
    [right, 0*hang]
    [figure:Kip_Pad]
    {Engineers need to be comfortable when they work hard, otherwise the best algorithms in the world will not save code from imploding in on itself. Hammocks, kale chips, and kombucha should be covered early in their textbooks.}
