...
These objects are released under the terms of the Ubuntu Font Family version 1.0, copyright \CopyrightDates\ \CopyrightHolder. See \in{section}[Ubuntu Font License] for the full text of the license.
\stopitemize
