...
This will generate a digital signature within the {\tt Signatures/} directory. This file can then be added and commit into the repository, or bundled as part of a larger commit, as described in \in{section}[Using Bzr]. 
