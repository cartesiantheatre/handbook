...
Taxation can be micromanged by players. They can create varying tax levels which effect different workforce groups and business types. Taxation factors may include: income, location, business type, polution, family size, education level, etc. In turn, higher or lower taxation is a method of shaping workforce and business direction, development, and evolution. 
