...
\item {\bf\em BRAVO} - CAPTURE ARCADIA
    ...
    \item DISARM ALL OF SIERRA'S\footnote{MARSCOM phonetic alphabet designation for a \quote{settler}.} SMALL ARMS.
...
\item {\bf\em CHARLIE} - ASSET EXTRACTION
    \startitemize[n]
...
%IN UNLIKELY EVENT MARSBAT1 / MARSBAT2 UNABLE TO HOLD ARCADIA, EMERGENCY CONTINGENCY PLAN TO EXECUTE:
%\startitemize[1]
%\item {\bf\em FOXTROT} - ASSET INSERTION

%    \startitemize[n]
%    \item OBJECTIVE BRAVO'S INSERTED PLAINCLOTHES NAU CIA, SPECIAL FORCES, AND BLACKWATER ASSETS REMAIN BEHIND IN ARCADIA TO CONDUCT OPERATIONS, NOW ACTIVATED AS 'FIFTH COLUMN' FUNCTIONING INDEPENDENTLY W/O NEED FOR EXTENDED COMMUNICATION CONTACT TO PROVIDE MARSCOM W/ UNIT BEHIND ARCADIAN DEMARCATION LINE FOLLOWING STRATEGIC RETREAT.

%    \item ACTIVATED 'FIFTH COLUMN' CONDUCT INSURGENCY AND EXECUTE FALSE FLAGS AS 'RED REVOLUTIONARIES'.

%    \item RAISING OF FUNDS IN LOCAL JENYA CURRENCY NECESSARY IF NOT REPLACED AS PER OBJECTIVE DELTA(3). NECESSARY TO SUPPORT FIFTH COLUMN OPERATIVES BEHIND SIERRA LINES. VERIFY SIERRA LABORATORY EQUIPMENT POSSIBLY CONDUCIVE TO NARCOTRAFFICKING.
%    \stopitemize

%\item {\bf\em GOLF} - FALLBACK TO RENDEZVOUS TANGO TO AWAIT EXTRACTION VIA ERV TO KALI, AREOSTATIONARY ORBIT.
\stopitemize
