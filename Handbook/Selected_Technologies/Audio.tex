...
This SDL module is used to provide audio decoding. It provides a standardized interface to various decoder backends, such as Ogg Vorbis and others. Audio programming under GNU/Linux is a mess,\footnotecite[tuxradar2010_linux_audio_mess] but APIs like this help make it sane for game developers.
\stopitemize
