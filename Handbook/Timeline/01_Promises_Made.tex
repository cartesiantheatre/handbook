...
\index{Mitsubishi--Saab}Mitsubishi--Saab is awarded a contract to robotically construct {\it Avaneya} remotely within the {\it Iterum Shipyard} orbital berth at a cost of β7.8 billion. {\it Avaneya} will carry the bootstrap crew and large amounts of construction equipment.

\index{Volvo--John Deere}Volvo--John Deere is awarded a contract to provide chemical propulsion systems for {\it Avaneya}, {\it Aravans}, and {\it Tarikins} at a cost of β920 million. It is used for the outbound trans--Martian trajectory, with the return methane/oxygen (\chemical{CH_4/O_2}) propellant manufactured {\it in situ}.
...
\index{Arda Baştürk}Arda Baştürk is named Mission Commander; \index{Henrik Nørgaard}Henrik Nørgaard as Chief Medical Officer and Chief Field Science Officer; \index{Senka Rukavina}Senka Rukavina as Flight Engineer, Mechanics Team Lead, and Survey Team Lead; \index{Khalid Zafar}Khalid Zafar as Systems Team Lead; and \index{Nayana Rai}Nayana Rai as Greenhouse Team Lead and Terraformation Team Lead. Further, \index{Leonard Kissinger}Leonard Kissinger is appointed United Nations Deputy Secretary--General and will accompany the crew as a viceroy of sorts.
\StopTimelineDate
...
\index{Avaneya}{\it Avaneya} completes all system checks and disembarks the {\it Iterum Shipyard} berth. It commences its six month journey with a delta--v from low Earth orbit injecting itself into a trans--Martian conjunction class orbital manoeuvre.
\StopTimelineDate
