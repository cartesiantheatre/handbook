...
\placefigure
    ...
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_All.pdf][][height=0.45\textheight]}

\placefigure
    []
    [figure:Units_User_Basic_Agricultural]
    {User's basic agricultural unit tree.}
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_Agricultural.pdf][][width=1.25\textwidth]}
...
\placefigure
    ...
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_Civic.pdf][][width=1.25\textwidth]}

\placefigure
    []
    [figure:Units_User_Basic_Education_and_Research]
    {User's basic education and research unit tree.}
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_Education_and_Research.pdf][][width=1.25\textwidth]}
...
\placefigure
    ...
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_Energy.pdf][][width=1.25\textwidth]}

\placefigure
    []
    [figure:Units_User_Basic_Health_Recreational_and_Social]
    {User's basic health, recreational, and social unit tree.}
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_Health_Recreational_and_Social.pdf][][width=1.25\textwidth]}
...
\placefigure
    ...
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_Production.pdf][][width=1.25\textwidth]}
    
\placefigure
    []
    [figure:Units_User_Basic_Transportation]
    {User's basic transportation unit tree.}
    {\externalfigure[Source/Game_Mechanics/Graphviz/Units_User_Basic_Transportation.pdf][][width=1.25\textwidth]}
...
\placefigure
    ...
    {\externalfigure[Source/Game_Mechanics/Graphviz/Simulation_Zones.pdf][][width=0.75\textwidth]}
