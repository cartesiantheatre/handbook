...
Another examples is in the cost of fast food. The upfront cost the consumer pays for a hamburger may be only 99 cents, but the actual true cost socialized to society and the environment is roughly \dollar 200.\footnotecite[extras={ p.~46.}][raj2010]
