...
Avaneya has an extensive unit tree as part of its game mechanics. Although the user may direct the locations and activities of units under their control, not all units in the unit tree the user will have access to -- nor will they know about or want them. Some units, such as certain types of vehicles and buildings, only agents within the world can create. We refer to these as non-playable units\index{Non-playable units} (NPUs)\index{NPUs}.
