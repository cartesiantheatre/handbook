...
\StartTimelineDate{A.R.}
Arda receives a UNSA directive to terminate an orthomolecular and several other alternative medical research programs occupying laboratory space. UNSA intends to lease the vacated facilities to the pharmaceutical company GlaxoKlineSmith.
\StopTimelineDate
...
Although consumption of the beverage had been a cultural practise in the settlement for many years, its widespread adoption had been preceded with the discovery that those exposed to higher than average cosmic radiation, such as during extended EVAs, had on average benefited from its consumption. Research conducted within settlement laboratories provided strong evidence that the fermented tea aided in the repair of radiation-induced cellular DNA damage.

Until now, the beverage had been a minor export back to Earth where it was notorious and held in high regard for being generally considered superior to any Terran grade. This was suspected due to the biochemistry of the symbiotic colony of bacteria and yeast used in its fermentation at work in a gravity lower than that experienced on Earth. As an expensive novelty item on Earth with many Terran counterfeits on the market, its possession had become symbolic of personal wealth.
\StopTimelineDate
...
\StartTimelineDate{A.R.}
Arda receives a UNSA directive to terminate all double blind herbal research studies being conducted by the settlement's laboratories hosting alternative medical research. UNSA cites the NAU Congress and EU Parliament having recently passed legislation listing herbs under settlement research, such as St. John's Wort, echinacea, and a number of others as contraband. Arda publicly criticizes GlaxoKlineSmith lobbyists.
\StopTimelineDate
...
\StartTimelineDate{A.R.}
Arda receives a UNSA directive to terminate several mushroom ranches. The ranches were used to recycle plant waste into high quality sources of edible protein. The energy used to maintain ranch temperature is reallocated for railgun use. All plant waste destined for the ranches or as greenhouse fertilizer now end up in newly created outdoor garbage dumps on the planitia where atmospheric conditions and cosmic radiation ensure organic matter will neither degrade nor become reusable.
\StopTimelineDate
...
\StartTimelineDate{A.R.}
Arda directs the systems team to take out UNSA orbital surveillance capabilities by destroying the {\it Mars Enhanced Telecommunications Orbiter} while they still have access. UNSA transmits a command sequence to the orbiter to revoke Arcadia's keypair but is eight minutes too late. The orbiter burns up its entire attitude control hydrazine fuel reserves, causing it to deorbit itself and be incinerated during atmospheric entry. 
