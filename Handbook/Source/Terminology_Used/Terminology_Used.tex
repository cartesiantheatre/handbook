...
% Jenya...
\startsection{Jenya}
{\it Article VII} of Arcadia's {\it \index{Rubicon Act}} superannuated the \index{bancor} \index{fiat currency} with the {\it \index{jenya}}. It is the first currency to be backed by a predominantly \index{rhodium standard}, with the remainder by other precious metals, such as gold and silver. The jenya became the exclusive legal tender within the Republic at the time the Act was passed. This constrained all Terran interests to acquire Arcadian goods in jenyas only.

The word {\it jenya} is \index{Sanskrit}. It means {\it "of noble origin, genuine, or true wealth"}. The idea being that since rhodium is considered precious, indeed, more so than gold on both Earth and Mars, distribution of jenyas across society implied a distribution of real wealth to everyone.
...
\bTR
  ...
  \bTC Needed \eTC
  \bTC Needed \eTC
  \bTC These buildings are attractive because they are economical and very light to pack, requiring fabric only 0.2 mm in thickness. For plants, they are fine since plants require only 50 mb of pressure. But for humans, they need at least 170 mb to be able to live. \eTC
\eTR
\bTR
  \bTC 170 mb \eTC
  \bTC Needed \eTC
...
\placeformula[formula:Sebatier Reaction]
\startformula
\chemical{CO_2,PLUS,4H_2,GIVES,CH_4,PLUS,2H_2O,PLUS,heat}
\stopformula
