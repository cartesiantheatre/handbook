...
Units will have a list of all influences on them, if a unit has an interest slot open each time its comes across an influence of that same interest than the influence is recorded and summed over time until the interest is finally generated. If it is easier for processing speed these lists can be terminated after a certain amount of time of no increase in influence.

Generally once an interest slot it occupied it will remain so. Each unit will have (...) number of interests slots that may fluctuate over its lifespan allowing for fluidity.


%%%rates of interests generation%%%
Different experiences and influences affect their specific interest at different rates so interests in some area will be created quicker than in others. A example is be food, influences of junk food (food high in fats and sugars) increase at a rate quicker than interests of healthy food. Influences created with social groups also increase quicker, such as sharing meals with family, or seeing movies with friends.
