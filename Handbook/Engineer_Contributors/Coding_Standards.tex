...
You are welcome to use any editor or IDE you like, provided it does not require non--standard IDE--specific project files to pollute the repository's source tree. So feel free to use CodeBlocks or whatever you like, just do not commit its project files to the repository or alter the build environment such that everyone requires it. See \in{section}[Developer Tools] for a list of all other developer tools required for this project.
