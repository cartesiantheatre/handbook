...
% Bancor...
\startsection{Bancor}
A global currency proposed in the early 1940s by the British economist John Maynard Keynes. On 13 April 2010, the {\sl Strategy, Policy and Review Department of the International Monetary Fund} published a paper {\sl Reserve Accumulation and International Monetary Stability}\footnote{\fullahref{http://www.imf.org/external/np/pp/eng/2010/041310.pdf}} recommending the world adopt the bancor and create an international central bank to administer it.
...
Conversely, the GPI, like the GDP, would also account for the total value of all cigarettes sold. Where it differs is it then goes on to subtract the dollar figures socialized to everyone in the form of health costs, fires, garbage collection, environmental toxicity, and the deaths of approximately 5,000,000\footnote[]{See \about[Merchants of Doubt]} people every year. The GDP calculated a gain. The GPI revealed it was actually a deficit.

% Jenya...
\startsection{Jenya}
{\sl \index{Article VII}} of Arcadia's {\sl Rubicon Act} superannuated the bancor fiat currency with the {\sl \index{jenya}}. It is the first currency to be backed by a predominantly rhodium standard, with the remainder by other precious metals, such as gold and silver. The jenya became the exclusive legal tender within the Republic at the time the Act was passed. This constrained all Terran interests to acquire Arcadian goods in jenyas only.
...
Mars Direct is a \type{$}50 billion dollar plan proposed by an American aerospace engineer named \index{Robert Zubrin} (born April 19, 1952) as an alternative to the prohibitively costly \type{$}450 billion dollar mission to Mars proposed by NASA in consultation with its government.

The then incumbent \index{President of the United States}, \index{George H. W. Bush}, announced the government's proposal in 1989 as the {\sl \index{Space Exploration Initiative}}. It called for the creation of the {\sl \index{Space Station Freedom}} and a permanent \index{Lunar base} as intermediate steps for an ultimate destination to the Red Planet. If implemented, it was to be rolled out over the process of several decades.
...
Zubrin compared their approach to the failed Arctic explorer, \index{Sir John Franklin}, who, with government assistance in 1845 took two ships, the {\sl Erebus} and {\sl Terror}, each displacing more than 300 tonnes in an effort to navigate through the \index{Northwest Passage}. His ships carried all manner of useless items, including heavy English silverware, but spared many of the critical items necessary for survival. 
...
The {\sl \index{Armstrong Limit}} of 62.62 millibars is the lowest the human body can survive before the vapour pressure of all exposed liquids (but not liquids like blood within your skin's pressure barrier), such as tears, saliva and the liquid wetting the alveoli within the lungs exceeds that of its surrounding atmospheric pressure. They will begin to boil away at this point. On Earth, the Armstrong Limit begins at about 19 km above the surface. On Mars, it is already well exceeded at the surface.

\placetable[here][tab:pressure ratings]{Martian building pressure ratings.}
\starttable[|c|c|c|c|]
\HL
\NC \bf Pressure \NC \bf Respirator \NC \bf EVA Suit \NC \bf Description \NC\SR
\HL
\NC 68 mb
\NC Needed
\NC Needed
\NC These buildings are attractive because they are economical and very light to pack, requiring fabric only 0.2 mm in thickness. For plants, they are fine since plants require only 50 mb of pressure. But for humans, they need at least 170 mb to be able to live.
\NC\FR
\NC 170 mb
\NC Needed
\NC Unneeded
\NC These buildings cost a little bit more, but you can work in them without wearing a pressure suit. You still need to wear a respirator in order for the gas exchange taking place in your lungs to still work, otherwise you will quickly pass out.
\NC\MR
\NC 340 mb
\NC Unneeded
\NC Unneeded
\NC These buildings cost a little bit more, but you can work in them without wearing a pressure suit or respirator, although the O₂ partial pressure levels still need to be enriched. The other main advantage is that the pressure can also be equalized with a habitat making movement easier. As an added bonus, bees can polinate better at this pressure coupled with the lower gravity which makes it excellent for greenhouses.
\NC\MR
\NC 1 bar
\NC Unneeded
\NC Unneeded
\NC These buildings cost the most, but they offer at least the same pressure as on Earth. Since everything needs to be three times as heavy as it needs to be, it is a waste of resources, too costly, and unnecessary.
\NC\LR
\HL
\stoptable
...
%CO_2(g) + H_2(g) \rightarrow O_2(g) + CO(g)
...
% Sol...
\startsection{Sol}
Short for solar day, the length of time a planet takes to rotate completely on its polar axis with respect to the sun. Terrans call this a day, Martians a sol. See also {\sl yestersol}.
