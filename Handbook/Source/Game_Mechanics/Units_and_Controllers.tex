...
\placetable[here,left,2*hang][table:Agricultural]{}
{
    \bTABLE[split=repeat]
...
\in{figure}[figure:User_Economy_and_Commerce_Tree] shows the user's basic {\it Economy and Commerce} tree. Everything appropriate that has to do with commerce, money supply, trade and exchange, we group into this category.
