...
\placefigure
    ...
    {Martian rocks and regolith as recovered from a rotting magnetic tape captured by a Viking Lander.}
    {\externalfigure[Source/Information_For_Artists/Images/Rocks.png][][width=.6\textwidth]}
