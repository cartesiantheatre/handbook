...
\StartTimelineDate{A.R.}
Arda receives a UNSA directive to terminate and vacate an orthomolecular laboratory and several other alternative medical research facilities. UNSA intends to lease the vacated facilities to the pharmaceutical company GlaxoKlineSmith.
\StopTimelineDate

\StartTimelineDate{A.R.}
Arda receives a UNSA directive to terminate and vacate the settlement's kombucha brewery. All equipment and most other material assets are to remain behind. Consumption of the fermented tea had been commonplace amongst the settlement. Colonists exposed to higher than average cosmic radiation, such as those regularly performing extended EVAs, had been using it successfully to repair damaged DNA.
\StopTimelineDate
...
\StartTimelineDate{A.R.}
Arda receives a UNSA directive to terminate all double blind herbal research studies currently being conducted by the settlement's few remaining alternative medical research facilities. UNSA cites the NAU Congress and EU Parliament having recently listed St. John's Wort, echinacea, and other herbs as contraband. Arda publicly criticizes GlaxoKlineSmith lobbyists.
\StopTimelineDate
