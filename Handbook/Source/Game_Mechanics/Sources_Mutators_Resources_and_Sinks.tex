...
\placefigure
    ...
    {\externalfigure[Source/Game_Mechanics/Diagrams/Legend.pdf][][width=1.0\textwidth]}
...
If you look carefully at \in{figure}[figure:Resources_Pipeline], you will notice that there are no sinks. We avoided putting these on the diagram because it would make it harder to read in linking every resource to all possible sinks to cover every conceivable situation. Instead, let us consider \in{figure}[figure:Resources_Sinks] to illustrate some of the possibilities with a reduced resource set.

\placefigure
    [force,here]
    [figure:Resource_Sinks]
    {Resources and sinks.}
    {\externalfigure[Source/Game_Mechanics/Diagrams/Sinks.pdf][][width=1.0\textwidth]}
