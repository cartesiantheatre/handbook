...
When a unit is in starvation mode it acts largely outside the boundaries of behavioural economics, instead it acts increasingly animalistic to meet its own needs. The Workforce Attributes - Workforce Units Needs section deals with this matter thoroughly, but in terms of units managing money or other resources to meet its needs when starving there are certain numerical factors that determine unit behaviour in this mode.

A unit will go without a lower need or part of a lower need to meet a higher need briefly
-A unit that has been without shelter for some time will meet a lower need to a lesser degree in order to access shelter if needed. So while the unit may not get to eat to fulfill its need, it will get some of its need met and some of its shelter met.

Going into cost ratios etc of when units in starvation mode 
