...
All chemical elements have one or more exotic variants of themselves that occur less frequently than their average form. Atoms of the same atomic number that vary in the number of neutrons they contain, and therefore atomic mass, are called {\it isotopes\index{isotope}}.

Hydrogen, denoted as \chemical{H}, as it most naturally occurs in the universe, contains only one proton and one electron. This isotope is called {\it protium\index{protium}} and is its most common variant. It is sometimes denoted as \chemical{^1H} when distinguishing it from other isotopes. The only other known isotope is called {\it deuterium} and is denoted as \chemical{^2H}. This is due to it having an atomic mass of two which accounts for both a proton as well as a neutron not found in protium. When two of them are combined with an oxygen atom, the resultant is called {\it heavy water\index{heavy water}}, \chemical{^2H_2O}.

On Earth, deuterium is very rare and accounts for only 0.0156\% of all naturally occurring hydrogen in its oceans. On Mars it is more plentiful by a factor of roughly five. About 166 in every million hydrogen atoms are deuterium on Earth, but on Mars, that number is about 833. The \goto{Reverse-Water-Gas-Shift}[Reverse-Water-Gas-Shift Reactor] reactor used heavily by Arcadias to produce water or, if split through electrolysis, hydrogen fuel or breathable oxygen, from the Martian atmosphere of \chemical{CO_2}, deuterium results as an inadvertent partial byproduct. About 1 kg of deuterium results for ever 6,000 kg of \chemical{H_2O} the reactor produces before electrolysis. Since heavy water takes slightly longer to split with electrolysis than regular water made of protium, if you keep cycling the water that has not yet been split back through electrolysis, eventually the concentration of heavy water increases until it is almost totally pure.

Deuterium is valued on Earth at about 70\% the value of gold per kilogram. By the late 20\high{th} century it was valued at about \type{$}10,000 per kilogram. It is useful in a range of applications from nuclear fusion and fission reactors to medical, biochemical, environmental, and more. If combined with oxygen into heavy water \chemical{^2H_2O}, it can be used for non-uranium enriched fission reactors that poor countries could benefit from. Since the Martian gravity is only a third that of Earth, the escape velocity, and therefore energy requirement, for \goto{railgun}[Railgun] export makes it a highly prized and feasible commodity for the Terran market. Since all water, oxygen, and many other Arcadian industrial processes produce deuterium as a byproduct, they will always have something valuable sought after.
...
\placefigure
    ...
    {\externalfigure[Source/Terminology/Images/Jenya_red.svg][][width=3cm]}
...
\placefigure
    ...
    {\externalfigure[Source/Terminology/Images/Law_of_Population_Growth.svg][][width=.5\textwidth]}
