...
Another important reason why this project is necessary is that there is very little, if any, {\it free} as in freedom\footnotecite[what_is_free_software], commercial, games for the GNU operating system. Even though there are many non--free games available for it, they ignore the issue of freedom.\footnotecite[nonfree_drm_games_on_gnu_linux] This is ironic because it was this issue of freedom that the GNU project set out to address.
