...
Depending on whether the user is playing single player or multiplayer, the game can take place in any one of a number of different {\it sectors}\index{Sector}. Sectors are geographical subdivisions of Mars that the user is immersed in. Grouping the planet as such is useful for a number of reasons.
