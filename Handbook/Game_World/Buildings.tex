...
Life support also provides waste recycling and water purification. Chemical--physical reactors are used for scrubbing \chemical{CO_2} out and the RWGS reactor is used for replenishing the \chemical{O_2} supply. 
