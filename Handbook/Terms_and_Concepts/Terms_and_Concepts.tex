...
Another examples is in the cost of a hamburger. The upfront cost the consumer pays may be only \type{$}0.99, but the actual true cost socialized to society and the environment is roughly \type{$}200.\footnotecite[extras={ p.~46.}][raj2010]
