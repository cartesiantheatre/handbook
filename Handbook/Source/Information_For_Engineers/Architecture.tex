...
The following architectural diagrams were pulled from the AresEngine's Umbrello project file automatically at the time this handbook was compiled on \currentdate\ from Bazaar revision \cldcontext{os.resultof"bzr revno | tr -d '\\n'"}.
...
\placefigure
    ...
    {\externalfigure[Images/AresEngine/Artificial Intelligence][width=\textwidth,height=\textheight,factor=max]}
\page
\setuppapersize[main]
