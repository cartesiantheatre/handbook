...
A partially restored Arcadia Hall is repopulated with staff overseeing the transfer of settlers from the shelter back to their homes mostly within the city. The shelter, whose means of movement in and out are few in number, becomes an easily guarded and practical prisoner of war camp for the quartering of the UNMEPF brigade.
...
Arcadian forces transport UNMEPF personnel, including the dead, to the dropsite for Kali's MADVs. Senka assists them with refuelling and performing preflight checks. Arda returns Nilhara's sidearm accompanied with a bottle of \index{Arcadian+Manowar}Arcadian Manowar. The pair salute prior to the spacecraft's ignition and ascent.
\StopTimelineDate

\StartTimelineDate{60 Leo, 2 A.R.}
For his courage in the defence of the city, Capt Henrik Nørgaard is awarded the {\it Order of Arcadia}\index{Order of Arcadia}, the republic's highest civic and military honour. Unit citations are also awarded to the {\it 1\high{st} People's Own Arcadian Mechanized Infantry}, {\it 2\high{nd} People's Own Arcadian Dragoons}, and the {\it 3\high{rd} People's Own Arcadian Combat Support Engineers}.
\StopTimelineDate
