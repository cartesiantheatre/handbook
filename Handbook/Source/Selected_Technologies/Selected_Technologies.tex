...
\CONTEXT\ is used for typesetting documents, such as this one. This document was compiled on \currentdate\ from Bazaar revision \cldcontext{os.resultof"bzr revno"}, typeset using \CONTEXT\ \contextversion, and rendered with \texenginename\ \texengineversion.
