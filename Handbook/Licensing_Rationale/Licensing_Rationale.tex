...
The AresEngine, shaders, Lua scripts, build environment scripts, and any other relevant executable data, are released under the terms of the GNU General Public License 3.0, copyright \CopyrightDates\ \CopyrightHolder. See \in{section}[GNU General Public License] for the full text of the license.

The Solnet server, build environment scripts, and any other relevant executable data are released under the terms of the GNU Affero General Public License, copyright \CopyrightDates\ \CopyrightHolder. See \in{section}[GNU Affero General Public License] for the full text of the license.
