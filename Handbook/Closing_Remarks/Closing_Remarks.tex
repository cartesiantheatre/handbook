...
The neoclassical economists unchecked assumption that we need to be passive cattle there to graze has to go. This project reminds all of us that we do not have to limit ourselves to merely being {\it consumers} of culture and information, {\it bit sinks}\index{bit sink}, but that we can also be {\it producers} of culture and information and need not wait on anyone. This is the spirit of {\it libre} culture.
