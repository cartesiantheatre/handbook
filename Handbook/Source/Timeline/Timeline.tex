...
\StartTimelineDate{B.R.}
The first of a long series of partisan meetings for settlement independence is held in secret with Arda in attendance. This underground effort is coined the \quote{Free Arcadia} movement.
\StopTimelineDate
...
\StartTimelineDate{A.R.}
Arda arrives by dirigible at {\it Valles Marineris}, a 4,000 km long canyon reaching up to 7 km in depth. He spends the day in solitary reflection.
...
\StartTimelineDate{A.R.}
Arcadia Hall instructs Starport Arcadia to begin fueling {\it ERV Bravo}, Earth-bound, to take advantage of the minimum-energy launch window. It authorizes the confiscation, revocation, and destruction of an irate Kissinger's visa. A security detail takes him into custody and escorts him to the starport. An automated solo departure lifting off later that evening will return him to Earth.
\StopTimelineDate
...
\StartTimelineDate{A.R.}
United Nations Security Council resolution 12664 is unanimously adopted discreetly, beginning with:
...
The resolution recommends and authorizes the {\it United Nations Department of Peacekeeping Operations} (UNDPKO) to place all four of its permanently standing {\it Rapid Reaction Force} battalions on high alert. Release of the statement is not yet made public.
\StopTimelineDate

\StartTimelineDate{A.R.}
Footage of alleged riots erupting across Arcadia with security forces responding disproportionately are aired across Earth. Some critics note the equivalence of Terran gravity in the footage. They are dismissed by mainstream media as \quote{cranks} and \quote{conspiracy theorists}.
\StopTimelineDate

\StartTimelineDate{A.R.}
The United Nations Department of Peacekeeping Operations' {\it Joint Chiefs of Staff} assemble in Brussels, European Union, where they liaise with government officials and high level military UN servants for the first day of a three month summit. The summit is conducted under maximum security. Though its existence is made public, the summits exercise of a high level of discretion in its activities ensures that its nature is not. This draws public suspicion.

Rumours rapidly spread over the solnet purporting the purpose of the summit is to plan the first off world military occupation of another planet in history. It must therefore concern itself with the preparation of all strategic, tactical, logistical, personnel, and financial planning necessary to conduct such an operation. Known high level UNSA liaisons, including at one point even UNSA's President Dr. Samuel Lieberman himself, are photographed being escorted in and out of meetings. Public speculation is further compounded with the exposure over the solnet of photographs captured of representatives from major financial institutions being shuttled in and out of meetings.
\StopTimelineDate
...
\StartTimelineDate{A.R.}
Arda receives an asymmetrically encrypted message warning of an imminent plan by a consortium of Terran nations to be delivered through the United Nations. The plan would call for the organization and landing of a single battalion of peacekeepers {\it in situ} to a Martian theatre. They would be tasked with the capture of Arcadia and all of its assets; put down any local resistance encountered; bring about temporary martial law; rig a settlement election; replace Arcadia Hall's incumbent Office of the President with a newly appointed, compromised, President sympathetic to Terran central banking cartels; conduct extrajudicial detentions, trials, and executions of the core \quote{Free Arcadia} movement's ring leaders, and in the case of Arda, an extrajudicial rendition back to Earth; revert the settlement's currency back to the Terran bancor, and to put settlement personnel back to work through the resumption of stable deuterium exports as expeditiously as possible.

The anonymous tip-off contains detailed information on troop movement to Terran UNSA training facilities, size of units, weapons and tactics to be employed, probable locations of encampment, and route of approach. UNSA allegedly intends to transport the battalion under the handle of a {\it United Nations Emergency Assistance Peacekeeping Force}. Its numbers are drawn principally from North American Union and European Union airborne light infantry units.
