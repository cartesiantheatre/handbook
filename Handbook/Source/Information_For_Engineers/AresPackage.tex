...
\placefigure
    ...
    {\externalfigure[Images/AresPackage/Root.png][][width=1\textwidth]}
\placefigure
    [force][figure:AresPackageManifestSchema]
    {The schema for the {\tt Files} element of an AresPackage manifest.}
    {\externalfigure[Images/AresPackage/Files.png][][width=1\textwidth]}
\placefigure
    [force][figure:AresPackageManifestSchema]
    {The schema for the {\tt File} tag of an AresPackage manifest.}
    {\externalfigure[Images/AresPackage/File.png][][width=1\textwidth]}
