...
In some sense, Avaneya is part of the effort to complete the GNU operating system. When the GNU project set out to replace the body of non-free software required to use a computer, Richard Stallman once remarked that it also requires games since a complete system needs games too.\footnote{\fullahref{http://www.gnu.org/gnu/linux-and-gnu.html}} One of the aims of this project is to help achieve that goal.
