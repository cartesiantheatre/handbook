...
\head {\em Governments are fundamentally nefarious.}

Government is among the leading causes of death.\footnotecite[statistics_of_democide] It is generally there to protect the interests of a few unelected principle benefactors, not to make changes in the public interest.\footnotecite[report_from_iron_mountain] Democracy is permitted only so long as it remains cosmetic only and does not actually threaten the aforesaid.\footnotecite[extras={ Select the {\it Votes} column to sort demand by vote.}][occupy_poll]
...
Usury, including fractional reserve banking, is slavery.\footnotecite[the_creature_from_jekyll_island]\footnotecite[minutes_bank_of_canada]
