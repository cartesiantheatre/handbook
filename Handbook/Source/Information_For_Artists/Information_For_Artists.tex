...
The {\it Avaneya: Viking Lander Remastered} archive is an effort to remedy this situation constructively. It doubles in giving our artists what they need, and also provides the general public with an invaluable educational resource. The software tool we engineered generates most of our remastered archive in the form of lossless PNG images which everyone already has software that can open. This software is described in greater detail in \in{section}[VikingExtractor]. We used two source data sets as the basis for our new archive.
