...
In ... period of time, intimate relationship can be switched by better option coming along. In this case the unit will switch intimate friendship to the new unit who offers better conditions.
...
However as relationships age the above conditions become superficial and the relationships will be more enduring. In one of the above examples (#1,#2,#3,#4) that result in a match add curent relationship duration to match calculations prior to determining if new match takes place.
Likewise - living together
	 - child/ren 
