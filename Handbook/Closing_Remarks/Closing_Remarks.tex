...
The neoclassical economist's unchecked assumption that we can be modelled as passive cattle there to graze has to go. This project reminds all of us that we do not have to limit ourselves to being merely {\it consumers} of culture, technology, and information, {\it bit sinks}\index{bit sink}, but that we can also be {\it producers} of all these things. We need not wait on anyone. This is the spirit of {\it libre} culture.
