...
Arda and his settlers erected their settlement of Arcadia in the {\it Arcadia Planitia} region. It is named after the Arcadia region of Ancient Greece, which was, in turn, named after the Greek legend of Arcas\index{Arcas}. This location was selected because there is plenty of water ice, a stable climate, and year round sunlight.
...
Incredibly, while researching the aesthetics of the Martian surface, we found that in all the decades passed since the Viking landers sent their images back to Earth, there does not appear to be so much as a single, complete, user friendly, archive of all the images. So you can forget downloading a convenient archive of PNGs from NASA's website intended for a layman.
...
And while both sources' raw data are now available to everyone as public domain, the entire latter SDDPT archive is encoded in a useless archaic format used during the Viking mission between July 20, 1976 to November 5, 1982. As you might expect, there aren't many experts around today at NASA to explain its specification. We know this because they told us so.
