...
The latter category of {\it Zones} does not necessitate a {\it specific} building for the user to erect, but rather, a region managed by the simulation of which it will control and erect as circumstance warrants. These zones include {\it Agricultural}, {\it Commercial}, {\it Habitat}, {\it Habitat and Commercial}, {\it Industrial}, and {\it Unzoned}.
