...
As software increases in complexity, so does the need to document how it works internally. Doxygen is a tool that can generate \index{engineering documentation}engineering documentation on the fly. The documentation is derived from metadata hints at the source code level. It can even produce graphs that show the relationship between classes. This latter feature is actually implemented internally using another set of tools we depend on, Graphviz.
