...
Proprietary technology developers usually create technology with the {\it profit motive}\index{profit motive} in mind. While it is important that free software is sustainable, the {\it purpose motive}\index{purpose motive} is at least as fundamental. This is why free software tends to be of higher craftsmanship. Free software developers want to build powerful technology too, but they have a tendency to not ignore the social context of the technology they create the way other technologists do. When we ignore the social context, technological tools can become dangerous when the superficial values that guided their creation are left to run their course.\footnotecite[black2012]\footnotecite[rotten_fruit2011_death_toll]\footnotecite[rotten_fruit2011_alarm_over_suicides]\footnotecite[rotten_fruit2011_stand_24_hours]\footnotecite[rotten_fruit2011_refused_benefits]
